...
type RPCClient interface {
	...
	EditOrder(ctx context.Context, Req *order.EditOrderReq, callOptions ...callopt.Option) (r *order.EditOrderResp, err error)
}
...
func (c *clientImpl) EditOrder(ctx context.Context, Req *order.EditOrderReq, callOptions ...callopt.Option) (r *order.EditOrderResp, err error) {
	return c.kitexClient.EditOrder(ctx, Req, callOptions...)
}
