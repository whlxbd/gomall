...
func (p *kOrderServiceClient) EditOrder(ctx context.Context, Req *order.EditOrderReq, callOptions ...callopt.Option) (r *order.EditOrderResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.EditOrder(ctx, Req)
}
